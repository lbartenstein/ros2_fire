...
class FireDetectorNode(Node): # ROS2
    def __init__(self):
    ...
    def image_callback(self, msg):
        ...
        try:
            processed_msg = self.bridge.cv2_to_imgmsg(processed_frame, "bgr8") # OpenCV ROS2 Image
    ...
    def process_frame(self, frame):
        ...
        for i in range(2):  
            ...
            results = None
            detected_model = None
            for model_name in self.detection_order: #  self.detection_order
                if model_name not in self.yolo_models: # self.yolo_models
